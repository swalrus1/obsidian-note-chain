...
To sum up, **note chains are like tags**, but you can merge and rename chains by modifying 1 note instead of every note with a tag, which is crucial for a knowledge base with thousands of notes.
